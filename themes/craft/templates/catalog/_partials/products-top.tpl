...
*}
  <div class="col-md-6 col-sm-6 col-xs-8 hidden-xl-down">
    <div class="row">
...
{*
   <div class="col-md-6" id="show-filters">
	  <span class="btn btn-primary"> {l s='Filter' d='Shop.Theme.Actions'}</span>
   </div>
*}
{*
 {if !empty($listing.rendered_facets)}
   <div class="col-md-6 col-sm-6 col-xs-4" id="show-filters">
	  <span class="btn btn-primary"> {l s='Filter' d='Shop.Theme.Actions'}</span>
   </div>
{/if}
*}
<div class="clearfix"></div>
  <div class="col-sm-12 hidden-md-up text-xs-center showing clearfix">
