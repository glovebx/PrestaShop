...
{*
    {block name='product_accessories'}
      {if $accessories}
        <section class="product-accessories clearfix col-md-12">
          <h3 class="after-product-title">{l s='You might also like' d='Shop.Theme.Catalog'}</h3>
          <div class="products accessories swiper-container">
	           <ul class="slider-products swiper-wrapper">
...
*}
   ...
   {block name='product_accessories'}
    {if $accessories}
      <section class="product-accessories swiper-container product-slider">
        <h3 class="after-product-title">{l s='You may also like' d='Shop.Theme.Catalog'}</h3>
