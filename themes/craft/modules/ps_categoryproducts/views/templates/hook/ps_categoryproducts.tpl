...
*}
<section class="categoryproducts col-md-12 swiper-container product-slider">
  <h2 class="after-product-title">
    {if $products|@count == 1}
  ...
  <div class="category-products swiper-wrapper">

      {foreach from=$products item="product"}
      <div class="swiper-slide">
          {include file="catalog/_partials/miniatures/product-category.tpl" product=$product}
      </div>
      {/foreach}
  </div>
  {if count($products) > 4}
