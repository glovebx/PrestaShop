...
*}
<a class="newsletter-link desktop hidden-md-down">{l s='Newsletter' d='Shop.Theme'}</a>
<a class="newsletter-link mobile hidden-lg-up">{l s='Newsletter' d='Shop.Theme'}</a>
...
<g>
	...
	<h2 class="h2">{l s='Subscribe to our Newsletter' d='Shop.Theme'}</h2>
